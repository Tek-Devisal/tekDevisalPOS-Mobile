...
Future<List<DailyCashRecievedModel>> fetchDailyCashRecieved(
  ...
  // print(shop_id);
  final url = Uri.parse(
      Server.instance.authority + 'api/v1/reports/daily-cash-recieved-report');
  ...
  try {
    ...
    if (jsonResponse is List) {
      return jsonResponse
          .map((data) => DailyCashRecievedModel.fromJson(data))
          .toList();
    } else {
      return [DailyCashRecievedModel.fromJson(jsonResponse)];
    }
  } catch (e) {
